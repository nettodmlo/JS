...
var salarioInicialDoFuncionario = parseFloat(prompt("Digite o salário inicial do funcionário: R$"));
var anosTrabalhados = 2023 - 1995;
var salarioFinalDoFuncionario = calcularSalarioAtual(salarioInicialDoFuncionario, anosTrabalhados);

console.log("O salário atual do funcionário é de R$ " + salarioFinalDoFuncionario);
